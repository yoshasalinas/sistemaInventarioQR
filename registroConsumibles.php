...
<html lang="en" dir="ltr">
	<head>
        ...
        <title>Registro Consumibles</title>
                        ...
                        <div class="form-row">
                            <div class="equipo col-12 ">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="capAlmacenamiento">Capacidad de almacenamiento:</label>
                                        <input type="text" class="form-control" id="capAlmacenamiento" name="capAlmacenamiento">    
                                    </div>
